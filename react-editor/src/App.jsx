  ...
  function onEditorMount(editor, monaco) {
    ...
    monaco.editor.defineTheme('textory-noir', {
      ...
      rules: [
        ...
        { token: 'string', foreground: '9EE3B6' },
        { token: 'number', foreground: '8FB7FF' },
        { token: 'keyword', foreground: 'B7A9FF' },
        { token: 'type.identifier', foreground: 'E6C38A' },
      ],
      colors: {
        'editor.background': '#090A10',
        'editor.foreground': '#E9EDF2',
        'editorLineNumber.foreground': '#4E5664',
        'editorLineNumber.activeForeground': '#9EE3B6',
        'editorCursor.foreground': '#9EE3B6',
        'editor.selectionBackground': '#1A2530',
        'editor.inactiveSelectionBackground': '#141C24',
        'editor.findMatchBackground': '#26231D',
        'editor.findMatchHighlightBackground': '#182126',
